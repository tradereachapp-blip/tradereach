            ...
            <div className="flex flex-col items-center justify-center min-h-[70vh] text-center relative z-10">
              ...
              <div className="grid gap-3 w-full mb-8">
                {[
                  ...
                  <div key={tip.title} className="flex items-start gap-3 bg-white/4 border border-white/8 rounded-xl p-3 text-left">
              ...
              <a
                href="/dashboard"
                className="block w-full bg-orange-500 hover:bg-orange-600 text-white font-black py-4 rounded-2xl text-base transition-all shadow-lg shadow-orange-500/30 hover:scale-[1.02] text-center"
              >
                Go to My Dashboard →
              </a>
            </div>
