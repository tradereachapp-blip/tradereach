...
export const metadata = {
  title: 'Free HVAC Quote — Trusted Local AC & Heating Contractors in Los Angeles',
  description: 'Get a free HVAC quote from a trusted local contractor in Los Angeles. Call within 2 hours. No obligation.',
}
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      <div className="max-w-lg mx-auto px-4 py-8 md:py-12">
        ...
        <p className="text-orange-400 text-xs font-bold uppercase tracking-widest text-center mb-3">
          Temperatures are rising. Get your AC checked before the summer heat hits.
        </p>

        {/* Headline */}
        <h1 className="text-3xl md:text-4xl font-black text-center mb-3 leading-tight">
          Is Your AC Ready for<br />
          <span className="text-orange-400">Summer, Los Angeles?</span>
        </h1>
        ...
        <div className="bg-gray-900 border border-white/10 rounded-2xl p-5 shadow-2xl">
          <h2 className="text-lg font-bold text-white mb-1">Get Your Free HVAC Estimate</h2>
          <p className="text-gray-500 text-xs mb-4">Takes 30 seconds. No obligation.</p>
          <LandingLeadForm defaultNiche="HVAC" />
        </div>
