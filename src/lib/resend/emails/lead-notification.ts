...
export function renderLeadNotification(props: LeadNotificationProps): string {
  ...
  const body = `
    ...
    <p style="margin:0 0 28px;font-size:15px;color:${BRAND.gray500};font-family:${BRAND.fontStack};">Hi ${contractorName} — a homeowner in your service area just requested a quote.</p>
